...
<div class="content">
	...
	<div class="content-text"><p>スタティー情報更新</p></div>
	
		<form method="post" action="/portpolio/studymodify" enctype="multipart/form-data">
			<div class="table">
			<table>
				<tr>
					<td>スタティー名</td>
					<td><input type="text" id="studyname" name="studyname" value="${modifyinpo.studyname}" required ></td>
				</tr>
				<tr>
					<td>人員</td>
					<td><label class="people"><input type="radio" id="quota" name="quota"
							value="3">3人명<input type="radio" name="quota" value="4">4人<input
				...
				<tr>
					<td>スタティー詳細 </td>
					<td><textarea cols="100px" rows="20px" name="content">${modifyinpo.content}</textarea></td>
